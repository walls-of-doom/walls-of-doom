...
#define PERK_DURATION_ON_SCREEN_IN_SECONDS 15
#define PERK_DURATION_ON_PLAYER_IN_SECONDS 10
#define PERK_DURATION_ON_SCREEN_IN_FRAMES                                      \
  PERK_DURATION_ON_SCREEN_IN_SECONDS *FPS
#define PERK_DURATION_ON_PLAYER_IN_FRAMES                                      \
  PERK_DURATION_ON_PLAYER_IN_SECONDS *FPS
